...
public class Call {
  ...
  public int setKey(String input, long len) {
    return pjsua2JNI.Call_setKey(swigCPtr, this, input, len);
  }

  public int setKeyByAndroid(String input, long len) {
    return pjsua2JNI.Call_setKeyByAndroid(swigCPtr, this, input, len);
  }

  public void setKeyId(OnCallSdpCreatedParam onCallSdpCreatedParam, String keyId) {
    pjsua2JNI.Call_setKeyId(swigCPtr, this, OnCallSdpCreatedParam.getCPtr(onCallSdpCreatedParam), onCallSdpCreatedParam, keyId);
  }

  public String getKeyId(OnCallSdpCreatedParam onCallSdpCreatedParam) {
    return pjsua2JNI.Call_getKeyId(swigCPtr, this, OnCallSdpCreatedParam.getCPtr(onCallSdpCreatedParam), onCallSdpCreatedParam);
  }
  ...
  public void answerWithKeyId(CallOpParam prm, String keyId) throws java.lang.Exception {
    pjsua2JNI.Call_answerWithKeyId(swigCPtr, this, CallOpParam.getCPtr(prm), prm, keyId);
  }
