...
public class QuickIndexBar extends View {
    ...
    private int COLOR_DEFAULT = Color.BLUE;
    ...
    private void init() {
        ...
        paint.setColor(getResources().getColor(R.color.bar_green));
        paint.setTextSize(SupportMultipleScreensUtil.getScaleValue(10));
        //设置文字被绘制的起点为底边的中心
